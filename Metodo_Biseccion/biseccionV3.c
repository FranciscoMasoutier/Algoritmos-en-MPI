...
int main(int argc, char *argv[]) {
	...
	do{
		...
		double resultadoAux[TAM_RESULTADO];
		MPI_Scatter(&resultados, 1, MPI_DOUBLE, &resultadoAux, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
		MPI_Gather(&resultadoAux, 1, MPI_DOUBLE, &resultados, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
